...
export default async function IndustrialWasteLicensesList({ contractorId }: { contractorId: number }) {
    ...
    <div className="py-12">
      ...
      <ul role="list" className="mt-7 divide-y divide-gray-100">
        {licenses.map((license) => {
          ...
          return (
            <li key={license.id} className="relative flex justify-between gap-x-6 py-5">
              ...
              <div className="flex shrink-0 items-center gap-x-4">
                <div className="flex flex-col items-end">
                  <p className="text-sm leading-6 text-gray-900">{daysLeft <= 30 && daysLeft > 0 && (
                    <>
