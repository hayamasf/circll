...
export default function Select({ id, label, name, options, validation }: { id: string, label: string, name: string, options: { value: string, label: string }[], validation?: RegisterOptions }) {
